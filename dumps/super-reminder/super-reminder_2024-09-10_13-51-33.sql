...
CREATE TABLE `task` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=110 DEFAULT CHARSET=utf32;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-09-10 15:51:33
