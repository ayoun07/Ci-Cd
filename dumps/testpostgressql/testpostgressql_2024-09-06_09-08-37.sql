...
COPY public.departments (department_id, department_name, department_description) FROM stdin;
\.
...
COPY public.employees (emp_id, first_name, last_name, email, department_id, job_title, salary) FROM stdin;
\.
...
COPY public.projects (project_id, project_name, project_description, start_date, end_date, department_id) FROM stdin;
\.
