...
<body>
    <div class="container-fluid d-flex">
        ...
        <div class="col-auto ms-auto">
            <button type="button" id="btnajout" data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-primary d-flex flex-row align-items-end">Create restore +</button>
