<nav class="navbar bg-body-tertiary d-flex flex-column vh-100" style="width: 110px;" data-bs-theme="dark">
    <div class="container-fluid">
        <a class="navbar-brand" id="basesafe" href="index.php">
            <img class="safebaseico" src="safebase.ico" alt="SafeBase Icon" /></br>SafeBase
        </a>
        <div class="navbar-collapse" id="navbarNav">
            <ul class="navbar-nav flex-column">
                <li class="nav-item">
                    <a class="nav-link" id="base" aria-current="page" href="index.php">
                        <i class="fas fa-database"></i></br>Databases</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="backup" href="Backups.php">
                        <i class="fas fa-backward"></i></br>Backups</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="Restorations.php">
                        <i class="fas fa-trash-can-arrow-up"></i></br>Restorations</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="bell" href="Alerts.php">
